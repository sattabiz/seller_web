...
// dynamic getPanelElementInList(List<dynamic> list, String variable) {
//   for (var element in list) {
...
// dynamic calculateTaxRate (double taxRate, amount) {
//   return (taxRate/100 * amount);
// }

// dynamic calculateTotalCost (double totalTaxRate, totalAmount) {
//   return (totalAmount + totalTaxRate);
// }

// String costCalc(List<dynamic> list, String caseName) {
//   switch (caseName) {
//     case "amount":
//       return calcuteAmount(getPanelElementInList(list, 'amount').toString(), getPanelElementInList(list, 'price').toString());  
//     case "tax_amount":
//       return calculateTaxRate(getPanelElementInList(list, 'taxRate'), calcuteAmount(getPanelElementInList(list, 'amount'), getPanelElementInList(list, 'price'))).toString();  
//     case "total_cost":
//       return calculateTotalCost(
//         calculateTaxRate(
//           getPanelElementInList(list, 'taxRate'), 
//           calcuteAmount(
//             getPanelElementInList(list, 'amount'), 
//             getPanelElementInList(list, 'price')
//           )
//         ),
//         calcuteAmount(getPanelElementInList(list, 'amount'), getPanelElementInList(list, 'price'))).toString();   
//     default:
//       return '--';
//   }
// }
